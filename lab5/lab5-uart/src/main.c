...
int main(void)
{
    ...
    //uart_puts("done\r\n");
    uart_puts("\x1b[1;31m");  // 1: bold style; 31: green foreground
    uart_puts("This is all red and bold\r\n");
    ...
    uart_puts("\x1b[0m");     // 0: reset all attributes
    //uart_puts("This is Normal text again\r\n");
    uart_puts("\x1b[2;34m");  // 4: underline style; 32: green foreground
    uart_puts("This is all blue and normal\r\n");
    uart_puts("\x1b[0m");     // 0: reset all attributes
    //uart_puts("This is Normal text again\r\n");
    uart_puts("\x1b[3;33m");  // 4: underline style; 32: green foreground
    uart_puts("This is all yellow and curved\r\n");
    uart_puts("\x1b[0m");     // 0: reset all attributes
    uart_puts("This is Normal text again\r\n");
